...
// (3) [ '제가 어제 먹은 음식은 ', '그리고 ', '입니다.', raw: Array(3) ]
// (2) [ '피자', '치킨' ]

<br>- [...new Set(arr)]로 중복 요소를 제거한 새로운 Set 객체 생성 가능
...
즉 객체를 키로 쓸 때나 뭐 이럴 때
객체는 널이 되어도 맵이 살아있으면 안지워짐
구지 필요는 없음

const user = {name: "adw", age: 29}
